...
export default function BootstrapIcon() {
    return (
        <svg viewBox="0 0 128 128" className={`${styles.bootstrapEffect} ${styles.icons}`}>
            <defs>
                ...
                <filter id="bootstrap-original-c" x="161.9" y="135.46" width="197" height="249" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
